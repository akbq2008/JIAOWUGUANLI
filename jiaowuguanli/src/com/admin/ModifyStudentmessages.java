...
public class ModifyStudentmessages implements ServletRequestAware,
	...
	public String ModifyStudentmessages() throws IOException {
		// TODO Auto-generated method stub
		...
		String back_zy = req.getParameter("ZY");
		...
		try {
			...
			if (back_NL != null && back_Idnumber != null
				...
				if (rs2.next()) {
					cond = "update student set XM='" + back_xm + "',XB='"
							+ back_xb + "',NL='" + back_nl + "',ZY='" + back_zy
