...
public class Jiaoxueplan extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		String mess = req.getParameter("JSH");
		Connection con = null;
		String cdn = "";
		...
		try {
			...
			cdn = "SELECT * FROM tc WHERE JSH='" + mess + "'";
		...
		resp.sendRedirect("/demo9/teacher/showplan.jsp");
