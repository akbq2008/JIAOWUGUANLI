...
public class Chaxunjieguo extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		 ...
		 */
		String kch = req.getParameter("KCH").trim();
		Connection con = null;
		String cdn = "";
		...
		try {
			...
			cdn = "SELECT * FROM sc WHERE KCH='" + kch + "'";
		...
		resp.sendRedirect("/demo9/teacher/showresult.jsp");
