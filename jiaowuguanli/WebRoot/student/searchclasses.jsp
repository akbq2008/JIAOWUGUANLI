...
<body>
	...
	<div id="skin">
		...
		<div id="top">
			<div class='top-list'>
				<ul>
					<li><i class='main-page top-pic'></i><span
						class='txt'><a href='javascript:void(0);' class='student'>学生主页面</a></span></li>
					<li  class='selected'><i class='select-classes top-pic'></i><span class='txt'><a
		...
		<div id="main">
		     <div class="main-left visible">
		         <dl>
			     	<dt>选课</dt>
			     	<dd class="ready-select"><i class="main-left-pic"></i><p>预选</p></dd>
			     	<dd class="select-results"><i class="main-left-pic"></i><p>选课结果</p></dd>
			     </dl>
			     <span class="main-open-close"></span>
			  </div>
			<div class="main-right">
		         <div><i class="main-right-box"></i></div>
		         <div class="pic-information"><p>浙江绿谷,秀山丽水！</p></div>
		     </div>
		     <div class="main-serarch-box"></div>
		     <span class="pager-line"></span>
		     <div class="pager"></div>
		     <div class="pager2"></div>
		     <!--  <div class="pager2"></div> -->
             <!-- <div class='xuanke'>
				<form action="/demo9/searchclasses" method="post" class='form1'>
					点击下面开始选课 <input type='submit' name='g' value='提交'>
				</form>
				<form action="/demo9/Handlexuankeresult" method="post" class='form2'>
					查看选课结果 <input type='submit' name='b' value='提交'>
				</form>
	...
	<script src="../js/searchclasses.js" charset="utf-8"></script>
