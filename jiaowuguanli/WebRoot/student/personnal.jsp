...
<link rel="stylesheet" href="../css/personnal.css">
...
<body>
	<div id="main-body">
		...
		<div id="top">
			<div class='top-list'>
			 <ul >
				...
				<li class='selected'><i class='select-personal-informations top-pic'></i><span
		...
		<div id="main">
            <div class="main-left visible">
		         <dl>
			     	<dt>选课</dt>
			     	<dd class="ready-select"><i class="main-left-pic"></i><p>个人信息</p></dd>
			      </dl>
			...
			<!-- <div class='form1'>
				<form action="/demo9/personnal" method="post">
	...
	<script src="../js/personnal.js" charset="utf-8"></script>
</body>
</html>